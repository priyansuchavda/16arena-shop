...
export function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  // Auto-focus input fields on step changes or modal opens
  useEffect(() => {
    if (isOpen) {
  ...
  const handleUnsupportedAuth = () => {
    setError("Only Google, Phone, or Email OTP authentication is supported currently.");
  };
