...
import { CATEGORY_HERO_BOTTOM_FADE, CATEGORY_HERO_IMAGE_MASK, CATEGORY_HERO_LEFT_FADE, CATEGORY_HERO_OVERLAY, CATEGORY_HERO_RIGHT_FADE, type CategoryHero } from "@/features/shop/utils/category-heroes";
