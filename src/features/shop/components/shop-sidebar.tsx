...
import { CategoryNavIcon } from "@/features/shop/components/category-nav-icon";
...
export function ShopSidebar({ items, onSelectCategory }: ShopSidebarProps) {
  ...
  return (
    <aside
      ref={containerRef}
      className="shop-scroll relative flex flex-1 flex-col items-start gap-0.5 overflow-x-visible overflow-y-auto pt-6 pb-6 pl-9 w-full"
    >
