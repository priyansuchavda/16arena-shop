...
/** Related items for a detail page (excludes the current product). */
...
/** Map a static sample product into the shared card model. */
...
/** Live redemption feed — social proof in the product's own kill-feed voice. */
